                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        ...
                        <Box my={3} className={classes.smallScreenCenter}>
                            <Box display='flex' my={1} className={classes.boxScreenCenter}>
                                <HomeOutlinedIcon />
                                <Typography component='span' className={classes.spacingLeft}>Comilla-3500, Bangladesh</Typography>
                            </Box>
                            <Box display='flex' my={1} className={classes.boxScreenCenter}>
                                <PhoneOutlinedIcon />
                            ...
                            <Box display='flex' my={1} className={classes.boxScreenCenter}>
                                ...
                                <Typography component='span' className={classes.spacingLeft}>muicommerce@gmail.com</Typography>
                            </Box>
